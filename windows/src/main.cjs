  ...
  return Menu.buildFromTemplate([
    {
      ...
      submenu: [
        ...
        { label: t("menu.terminalTextLarger"), accelerator: "Ctrl+Plus", click: () => mainWindow?.webContents.send("cmux-command", "terminal.fontUp") },
        { label: t("menu.terminalTextSmaller"), accelerator: "Ctrl+-", click: () => mainWindow?.webContents.send("cmux-command", "terminal.fontDown") },
        { label: t("menu.terminalTextReset"), accelerator: "Ctrl+0", click: () => mainWindow?.webContents.send("cmux-command", "terminal.fontReset") },
